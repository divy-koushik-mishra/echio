...
export default function Footer() {
  ...
  `}
      ...
      <div className="text-black bg-white">
        {/* bg-white */}
        <div className="mx-10 md:mx-20 mt-[8.75rem] mb-20 md:px-20 py-12">
          <div className="w-full  flex flex-row md:justify-between justify-around items-center mb-16">
            ...
            />
            <button
              className={`w-1/2 font-inter flex justify-center items-center border text-xl text-gradient border-gradient font-medium rounded-[0.25rem] px-6 py-3.5 button-gradient`}
            >
              Stay in Touch
            </button>
          </div>
