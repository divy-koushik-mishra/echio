...
export default function Agency() {
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-center items-center gap-16 mx-20 my-[8rem] md:my-[16rem]">
        <div className="flex justify-center items-center overflow-hidden">
          <Image src={agencyPage} alt="graph" className="md:w-4/6 md:h-[90%]" />
        </div>
