...
export const Button = ({ button, className, text, rectangleClassName }) => {
	...
	return (
		<div
			className={`border-transparent inline-flex items-center pl-[24px] pr-[16px] py-[11px] relative rounded-[4px] gap-[4px] [border-image:linear-gradient(to_bottom,rgb(199.76,248.38,255),rgb(25,194,217))_1] border border-solid h-[56px] justify-center cursor-pointer ${
		...
		>
			<div
				className={`[font-family:'Inter',Helvetica] w-fit tracking-[0] text-[20px] font-medium leading-[normal] whitespace-nowrap relative ${
